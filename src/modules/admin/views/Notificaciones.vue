      ...
      <div class="mb-8 p-6">
        ...
        <div class="flex items-center justify-between gap-4">
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-4">
              <button
                v-if="hasPermission('notificaciones_view')"
      ...
      <div v-else class="space-y-4 p-6">
        ...
        >
          <div class="flex items-start gap-4" @click.stop>
            ...
            <div class="flex items-center gap-2">
              <button
                v-if="!notification.read && hasPermission('notificaciones_view')"
...
<script setup lang="ts">
  ...
  const markAsRead = (notification: Notification) => {
    // Verificar permisos
    if (!hasPermission('notificaciones_view')) {
      toast.error('No tienes permiso para gestionar notificaciones');
      return;
    }
